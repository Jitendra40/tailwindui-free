...
const htmlBlock = `
  <div class="flex flex-wrap items-center gap-4">
          <!-- Download -->
          <button class="inline-flex cursor-pointer items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-semibold text-gray-700 shadow-sm transition-all hover:bg-gray-50 hover:text-gray-900 hover:shadow active:scale-95">
    ...
    <!-- Settings -->
          ...
          <button class="inline-flex cursor-pointer items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-semibold text-gray-700 shadow-sm transition-all hover:bg-gray-50 hover:text-gray-900 hover:shadow active:scale-95">
           ...
           <!-- Delete -->
           <button class="inline-flex cursor-pointer items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-semibold text-red-600 shadow-sm transition-all hover:bg-red-50 hover:text-red-700 hover:shadow active:scale-95">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4 text-red-500 group-hover:text-red-600">
...
<template>
  <PreviewWrapper
    title="⭐ Most Common Utility Buttons (Universal)"
    description="A comprehensive collection of utility buttons for file operations, data actions, system settings, and more. Pure HTML & Tailwind CSS."
