...
const htmlBlock = `
<div class="relative">
  <input type="text" id="floating_outlined" class="block w-full rounded-xl border border-input bg-white px-3 pb-2 pt-5 text-sm text-foreground appearance-none focus:border-primary focus:outline-none focus:ring-0 peer transition-all shadow-sm/50" placeholder=" " />
