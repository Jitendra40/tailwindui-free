...
<div class="bg-white px-6 py-24 sm:py-32 lg:px-8">
  <div class="mx-auto max-w-2xl text-center">
    ...
    <p class="mt-2 text-lg leading-8 text-gray-600">Quam nunc milim benso.</p>
  </div>
    <div class="mx-auto mt-16 max-w-2xl bg-gray-50 p-10 rounded-2xl">
...
<template>
  <PreviewWrapper title="Centered Contact" description="Centered form in a container." :html-block="htmlBlock">
    <div class="bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Get in touch</h2>
        <p class="mt-2 text-lg leading-8 text-gray-600">Quam nunc milim benso.</p>
