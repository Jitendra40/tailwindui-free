  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:max-w-none">
      <div class="text-center">
        ...
        <p class="mt-4 text-lg leading-8 text-gray-300">Lorem ipsum dolor sit amet consect adipisicing elit. Possimus magnam voluptatum cupiditate veritatis in accusamus quisquam.</p>
      </div>
...
<template>
  <PreviewWrapper title="Dark Statistics with Grid" description="Dark theme stats section with grid layout." :html-block="htmlBlock" />
</template>
