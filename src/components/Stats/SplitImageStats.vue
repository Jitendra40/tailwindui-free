  ...
  <div class="mx-auto grid max-w-7xl lg:grid-cols-2">
    <div class="px-6 pb-24 pt-16 sm:pb-32 sm:pt-20 lg:col-start-2 lg:px-8 lg:pt-32">
      <div class="mx-auto max-w-2xl lg:mr-0 lg:max-w-lg">
        ...
        <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Trusted by thousands of developers worldwide</p>
        ...
        <dl class="mt-16 grid max-w-xl grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 xl:mt-16">
          <div class="flex flex-col gap-y-3 border-l border-gray-900/10 pl-6">
            <dt class="text-sm leading-6 text-gray-600">Developers on the platform</dt>
            <dd class="order-first text-3xl font-semibold tracking-tight text-gray-900">8,000+</dd>
          </div>
          <div class="flex flex-col gap-y-3 border-l border-gray-900/10 pl-6">
            <dt class="text-sm leading-6 text-gray-600">Daily requests</dt>
            <dd class="order-first text-3xl font-semibold tracking-tight text-gray-900">900m+</dd>
          </div>
          <div class="flex flex-col gap-y-3 border-l border-gray-900/10 pl-6">
          ...
          <div class="flex flex-col gap-y-3 border-l border-gray-900/10 pl-6">
            <dt class="text-sm leading-6 text-gray-600">Projects deployed</dt>
            <dd class="order-first text-3xl font-semibold tracking-tight text-gray-900">12k</dd>
          </div>
        </dl>
      </div>
    </div>
...
<template>
  <PreviewWrapper title="Split with Image" description="Stats section with a large image on the side." :html-block="htmlBlock" />
</template>
