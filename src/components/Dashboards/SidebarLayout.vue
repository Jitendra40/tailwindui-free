    ...
    <div class="hidden md:flex md:w-64 md:flex-col">
        <div class="flex flex-col flex-1 min-h-0 bg-gray-800">
            <div class="flex items-center h-16 flex-shrink-0 px-4 bg-gray-900">
                <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=500" alt="Workflow">
            </div>
            <div class="flex-1 flex flex-col overflow-y-auto">
                <nav class="flex-1 px-2 py-4 space-y-1">
                    <a href="javascript:void(0)" class="bg-gray-900 text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                    ...
                    <a href="javascript:void(0)" class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
        ...
        <div class="relative z-10 flex-shrink-0 flex h-16 bg-white shadow">
            ...
            <div class="flex-1 px-4 flex justify-between">
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <!-- User Dropdown with Unsplash Avatar -->
...
<template>
  <PreviewWrapper title="Sidebar Layout" description="Admin dashboard layout with fixed sidebar and scrollable content area." :html-block="htmlBlock" />
</template>
