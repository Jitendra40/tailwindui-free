...
<template>
  <PreviewWrapper title="Simple Menu" description="Polished dropdown with smooth animations." :html-block="htmlBlock">
    <div class="relative inline-block text-left h-64 w-full flex justify-center pt-4">
