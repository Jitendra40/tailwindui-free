...
<div class="w-full px-4 sm:px-0">
  <nav aria-label="Progress">
    <ol role="list" class="flex flex-col sm:flex-row sm:items-center">
      
      <!-- Step 1: Complete -->
      <li class="relative w-full pb-8 sm:pb-0 sm:pr-8 md:pr-20">
        <div class="hidden sm:block absolute inset-0 top-4 flex items-center " aria-hidden="true">
        ...
        <a href="#" class="relative flex items-center sm:justify-center group">
          ...
          <span class="ml-4 min-w-0 flex flex-col sm:absolute sm:-bottom-8 sm:ml-0 sm:w-max sm:items-center">
             <span class="text-sm font-medium text-blue-600">Lead Captured</span>
          </span>
        </a>
      </li>
      ...
      <li class="relative w-full pb-8 sm:pb-0 sm:pr-8 md:pr-20">
        ...
        <a href="#" class="relative flex items-center sm:justify-center group">
          <span class="h-8 w-8 rounded-full bg-blue-600 flex items-center justify-center hover:bg-blue-700 transition-colors z-10 ring-8 ring-white sm:ring-0">
           ...
           <span class="ml-4 min-w-0 flex flex-col sm:absolute sm:-bottom-8 sm:ml-0 sm:w-max sm:items-center">
             <span class="text-sm font-medium text-blue-600">Contacted</span>
          </span>
        </a>
      </li>
      ...
      <li class="relative w-full pb-8 sm:pb-0 sm:pr-8 md:pr-20">
         <div class="hidden sm:block absolute inset-0 top-4 flex items-center" aria-hidden="true">
          <div class="h-0.5 w-full bg-gray-200">
            <div class="h-0.5 w-1/2 bg-blue-600"></div>
          </div>
        </div>
         <!-- Mobile Connector -->
        ...
        <a href="#" class="relative flex items-center sm:justify-center group">
          <span class="h-8 w-8 rounded-full bg-white border-2 border-blue-600 flex items-center justify-center z-10 ring-8 ring-white sm:ring-0">
           ...
           <span class="ml-4 min-w-0 flex flex-col sm:absolute sm:-bottom-8 sm:ml-0 sm:w-max sm:items-center">
             <span class="text-sm font-bold text-blue-600">Qualified</span>
          </span>
        </a>
      </li>
      ...
      <li class="relative w-full pb-8 sm:pb-0 sm:pr-8 md:pr-20">
        ...
        <a href="#" class="relative flex items-center sm:justify-center group">
          ...
          <span class="ml-4 min-w-0 flex flex-col sm:absolute sm:-bottom-8 sm:ml-0 sm:w-max sm:items-center">
             <span class="text-sm font-medium text-gray-500">Site Visit</span>
          </span>
        </a>
      </li>
...
<template>
  <PreviewWrapper
    ...
    description="Pipeline style progress bar."
